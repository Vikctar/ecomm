...
SECRET_KEY = config('SECRET_KEY', default='secret')  # default used in ci
...
EMAIL_HOST = config('MAIL_SERVER', default='smtp.gmail.com')
EMAIL_PORT = config('MAIL_PORT', default=587, cast=int)
EMAIL_USE_TLS = config('MAIL_USE_TLS', default=True, cast=bool)
EMAIL_HOST_USER = config('MAIL_USERNAME', default='email')
EMAIL_HOST_PASSWORD = config('MAIL_PASSWORD', default='password')
EMAIL_FROM = config('MAIL_FROM', default='from_email')
